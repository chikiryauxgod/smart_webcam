...
#ifndef GOOGLE_PROTOBUF_INCLUDED_result_5fservice_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_result_5fservice_2eproto
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_result_5fservice_2eproto;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::result_service::Frame* Arena::CreateMaybeMessage<::result_service::Frame>(Arena*);
template<> ::result_service::Result* Arena::CreateMaybeMessage<::result_service::Result>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace result_service {
...
class Frame final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:result_service.Frame) */ {
 public:
...
class Result final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:result_service.Result) */ {
 public:
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_result_5fservice_2eproto
